...
Z1_NAME=`ls | grep -i zoom[ _]1$`
Z2_NAME=`ls | grep -i zoom[ _]2$`
Z3_NAME=`ls | grep -i zoom[ _]3$`
Z4_NAME=`ls | grep -i zoom[ _]4$`
Z5_NAME=`ls | grep -i zoom[ _]5$`
Z6_NAME=`ls | grep -i zoom[ _]6$`
Z7_NAME=`ls | grep -i zoom[ _]7$`
Z8_NAME=`ls | grep -i zoom[ _]8$`
Z9_NAME=`ls | grep -i zoom[ _]9$`
Z10_NAME=`ls | grep -i zoom[ _]10$`
Z11_NAME=`ls | grep -i zoom[ _]11$`
Z12_NAME=`ls | grep -i zoom[ _]12$`
Z13_NAME=`ls | grep -i zoom[ _]13$`
Z14_NAME=`ls | grep -i zoom[ _]14$`
Z15_NAME=`ls | grep -i zoom[ _]15$`
...
INZ7="${VERT}\Fotos\\${Z7_NAME}"
INZ8="${VERT}\Fotos\\${Z8_NAME}"
INZ9="${VERT}\Fotos\\${Z9_NAME}"
INZ10="${VERT}\Fotos\\${Z10_NAME}"
INZ11="${VERT}\Fotos\\${Z11_NAME}"
INZ12="${VERT}\Fotos\\${Z12_NAME}"
INZ13="${VERT}\Fotos\\${Z13_NAME}"
INZ14="${VERT}\Fotos\\${Z14_NAME}"
INZ15="${VERT}\Fotos\\${Z15_NAME}"
...
NUMSEC=`echo ${MAXZOOM} | sed 's/zoom//g;s/_//g'` 

eval "cd \"${APPDIR}\""

SRCDIR=`ls ${TMPL} | grep " ${NUMSEC} SECTION"`
...
eval "cat \"${VERT}\\${SRCDIR}\01. Full_Site.html\" | sed 's/<h3>.\+<\/h3>/<h3>${SITE_NAME}<\/h3>/g;s/0032/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\01. Full_Site.html"
...
echo "Fixing the html file..."
eval "cat \"${VERT}\\${SRCDIR}\02. Container_Site.html\" | sed 's/0016/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\02. Container_Site.html"
...
eval "cat \"${VERT}\\${SRCDIR}\03. Zoom_1.html\" | sed 's/0028/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\03. Zoom_1.html"

eval "cat \"${VERT}\\${SRCDIR}\09. Zoom_1.A.html\" | sed 's/0028/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\09. Zoom_1.A.html"

eval "cat \"${VERT}\\${SRCDIR}\10. Zoom_1.B.html\" | sed 's/0028/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\10. Zoom_1.B.html"

eval "cat \"${VERT}\\${SRCDIR}\11. Zoom_1.C.html\" | sed 's/0028/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\11. Zoom_1.C.html"
...
eval "cat \"${VERT}\\${SRCDIR}\04. Zoom_2.html\" | sed 's/0027/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\04. Zoom_2.html"

eval "cat \"${VERT}\\${SRCDIR}\12. Zoom_2.A.html\" | sed 's/0027/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\12. Zoom_2.A.html"

eval "cat \"${VERT}\\${SRCDIR}\13. Zoom_2.B.html\" | sed 's/0027/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\13. Zoom_2.B.html"

eval "cat \"${VERT}\\${SRCDIR}\14. Zoom_2.C.html\" | sed 's/0027/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\14. Zoom_2.C.html"
...
eval "cat \"${VERT}\\${SRCDIR}\05. Zoom_3.html\" | sed 's/0027/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\05. Zoom_3.html"

eval "cat \"${VERT}\\${SRCDIR}\15. Zoom_3.A.html\" | sed 's/0027/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\15. Zoom_3.A.html"

eval "cat \"${VERT}\\${SRCDIR}\16. Zoom_3.B.html\" | sed 's/0027/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\16. Zoom_3.B.html"

eval "cat \"${VERT}\\${SRCDIR}\17. Zoom_3.C.html\" | sed 's/0027/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\17. Zoom_3.C.html"
...
eval "cat \"${VERT}\\${SRCDIR}\06. Zoom_4.html\" | sed 's/0022/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\06. Zoom_4.html"

eval "cat \"${VERT}\\${SRCDIR}\17. Zoom_4.A.html\" | sed 's/0022/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\17. Zoom_4.A.html"

eval "cat \"${VERT}\\${SRCDIR}\18. Zoom_4.B.html\" | sed 's/0022/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\18. Zoom_4.B.html"

eval "cat \"${VERT}\\${SRCDIR}\19. Zoom_4.C.html\" | sed 's/0022/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\19. Zoom_4.C.html"
...
eval "cat \"${VERT}\\${SRCDIR}\07. Zoom_5.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\07. Zoom_5.html"

eval "cat \"${VERT}\\${SRCDIR}\20. Zoom_5.A.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\20. Zoom_5.A.html"

eval "cat \"${VERT}\\${SRCDIR}\21. Zoom_5.B.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\21. Zoom_5.B.html"

eval "cat \"${VERT}\\${SRCDIR}\22. Zoom_5.C.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\22. Zoom_5.C.html"
...
eval "cat \"${VERT}\\${SRCDIR}\08. Zoom_6.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\08. Zoom_6.html"

eval "cat \"${VERT}\\${SRCDIR}\23. Zoom_6.A.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\23. Zoom_6.A.html"

eval "cat \"${VERT}\\${SRCDIR}\24. Zoom_6.B.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\24. Zoom_6.B.html"

eval "cat \"${VERT}\\${SRCDIR}\25. Zoom_6.C.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\25. Zoom_6.C.html"
...
eval "cat \"${VERT}\\${SRCDIR}\26. Zoom_7.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\26. Zoom_7.html"

eval "cat \"${VERT}\\${SRCDIR}\27. Zoom_7.A.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\27. Zoom_7.A.html"

eval "cat \"${VERT}\\${SRCDIR}\28. Zoom_7.B.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\28. Zoom_7.B.html"

eval "cat \"${VERT}\\${SRCDIR}\29. Zoom_7.C.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\29. Zoom_7.C.html"
...
eval "cat \"${VERT}\\${SRCDIR}\30. Zoom_8.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\30. Zoom_8.html"

eval "cat \"${VERT}\\${SRCDIR}\31. Zoom_8.A.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\31. Zoom_8.A.html"

eval "cat \"${VERT}\\${SRCDIR}\32. Zoom_8.B.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\32. Zoom_8.B.html"

eval "cat \"${VERT}\\${SRCDIR}\33. Zoom_8.C.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\33. Zoom_8.C.html"
...
eval "cat \"${VERT}\\${SRCDIR}\34. Zoom_9.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\34. Zoom_9.html"

eval "cat \"${VERT}\\${SRCDIR}\35. Zoom_9.A.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\35. Zoom_9.A.html"

eval "cat \"${VERT}\\${SRCDIR}\36. Zoom_9.B.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\36. Zoom_9.B.html"

eval "cat \"${VERT}\\${SRCDIR}\37. Zoom_9.C.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\37. Zoom_9.C.html"
...
eval "cat \"${VERT}\\${SRCDIR}\38. Zoom_10.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\38. Zoom_10.html"

eval "cat \"${VERT}\\${SRCDIR}\39. Zoom_10.A.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\39. Zoom_10.A.html"

eval "cat \"${VERT}\\${SRCDIR}\40. Zoom_10.B.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\40. Zoom_10.B.html"

eval "cat \"${VERT}\\${SRCDIR}\41. Zoom_10.C.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\41. Zoom_10.C.html"
...
eval "cat \"${VERT}\\${SRCDIR}\42. Zoom_11.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\42. Zoom_11.html"

eval "cat \"${VERT}\\${SRCDIR}\43. Zoom_11.A.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\43. Zoom_11.A.html"

eval "cat \"${VERT}\\${SRCDIR}\44. Zoom_11.B.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\44. Zoom_11.B.html"

eval "cat \"${VERT}\\${SRCDIR}\45. Zoom_11.C.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\45. Zoom_11.C.html"
...
eval "cat \"${VERT}\\${SRCDIR}\46. Zoom_12.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\46. Zoom_12.html"

eval "cat \"${VERT}\\${SRCDIR}\47. Zoom_12.A.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\47. Zoom_12.A.html"

eval "cat \"${VERT}\\${SRCDIR}\48. Zoom_12.B.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\48. Zoom_12.B.html"

eval "cat \"${VERT}\\${SRCDIR}\49. Zoom_12.C.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\49. Zoom_12.C.html"
...
eval "cat \"${VERT}\\${SRCDIR}\50. Zoom_13.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\50. Zoom_13.html"

eval "cat \"${VERT}\\${SRCDIR}\51. Zoom_13.A.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\51. Zoom_13.A.html"

eval "cat \"${VERT}\\${SRCDIR}\52. Zoom_13.B.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\52. Zoom_13.B.html"

eval "cat \"${VERT}\\${SRCDIR}\53. Zoom_13.C.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\53. Zoom_13.C.html"
...
eval "cat \"${VERT}\\${SRCDIR}\54. Zoom_14.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\54. Zoom_14.html"

eval "cat \"${VERT}\\${SRCDIR}\55. Zoom_14.A.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\55. Zoom_14.A.html"

eval "cat \"${VERT}\\${SRCDIR}\56. Zoom_14.B.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\56. Zoom_14.B.html"

eval "cat \"${VERT}\\${SRCDIR}\57. Zoom_14.C.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\57. Zoom_14.C.html"
...
eval "cat \"${VERT}\\${SRCDIR}\58. Zoom_15.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\58. Zoom_15.html"

eval "cat \"${VERT}\\${SRCDIR}\59. Zoom_15.A.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\59. Zoom_15.A.html"

eval "cat \"${VERT}\\${SRCDIR}\60. Zoom_15.B.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\60. Zoom_15.B.html"

eval "cat \"${VERT}\\${SRCDIR}\61. Zoom_15.C.html\" | sed 's/0019/${SEQ: -4}/g' " > c:\\temp\\tmp.out
mv c:\\temp\\tmp.out "${VERT}\\${SRCDIR}\61. Zoom_15.C.html"
